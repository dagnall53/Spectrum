...
def load_librtlsdr():
    ...
    # Explicitly try the DLL in the same directory as this file
    here = os.path.dirname(__file__)
    driver_files += [os.path.join(here, 'rtlsdr.dll'),
                     os.path.join(here, 'librtlsdr.dll')]
...
f = librtlsdr.rtlsdr_get_direct_sampling
f.restype, f.argtypes = c_int, [p_rtlsdr_dev]
